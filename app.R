  ...
  navbarPage(
    ...
    tabPanel(
      ...
      tabsetPanel(tabPanel(
        "Teoría", uiOutput("teoria"), mainPanel(fluidRow
                                                (
                                                  column(
                                                    6,
                                                    br(),
                                                    br(),
                                                    h4("Método de bipartición: ",style="color: #f2540c"),
                                                    br(),
                   ...
                   mainPanel(fluidRow
                             (
                               column(
                                 ...
                                 p("En la primera fila de la tabla se observan los coeficientes del polinomio de interpolación"),
                                 br(),
    ...
    tabPanel("Derivación", 
             uiOutput("opcion3"),
            tabsetPanel(tabPanel("Teoría",uiOutput("teoría"),
                    mainPanel(fluidRow(
                      column(
                        12,
                        br(),
                        ...
                        br(),
                        strong(" Fórmula de dos puntos descentrada a la derecha",style="color: #f2540c"),
                        br(),
                        p(
                          "$$\\begin{array}{c|cc}
                                    xi & x_0 & x_0 + h & ... \\\\
                        ...
                        strong("Fórmula de dos puntos descentrada a la izquierda",style="color: #f2540c"),
                        br(),
                        p(
                          "$$\\begin{array}{c|cc}
                                    xi & ... &  x_0 - h &  x_0  \\\\
     ...
     tabPanel("Ejemplos", uiOutput("EDerivacion"),
                mainPanel(navlistPanel(
